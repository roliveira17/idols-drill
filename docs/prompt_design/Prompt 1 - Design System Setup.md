...
Analyze this design screenshot and an css file, extract design tokens, and set up a complete design system with shadcn/ui.

## Input

[SCREENSHOT AND C:\projetos\gymrats\schemas\index.css]
